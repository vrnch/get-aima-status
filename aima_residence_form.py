#!/usr/bin/env python3
"""One-time local run: residence permit status request via AIMA contact form."""
...
CONFIG_PATH = SCRIPT_DIR / "aima_residence_config.json"
...
def main() -> None:
    ...
    try:
        ...
        tracking = submit_form(
            FormData(
                identity_type="residence",
                identity_number=config["residence_permit_number"],
